...
import com.facebook.nifty.legacy.server.util.ScopedNiftyServer;
...
import static com.facebook.nifty.legacy.server.util.ScopedNiftyServer.defaultServerDefBuilder;
...
public class TestNiftyClient
{
    ...
    public void testServerDisconnect()
            throws Exception
    {
        final ScopedNiftyServer server = makeServer();
        try {
    ...
    {
        scribe.Processor processor = new scribe.Processor<scribe.Iface>(new scribe.Iface()
        {
            @Override
