...
public interface NiftyClientChannel extends RequestChannel {
     ...
     * {@link NiftyClientChannel#setSendTimeout(com.facebook.nifty.legacy.units.Duration)}
     *
     * @return
     */
    ...
    /**
     * Returns the timeout most recently set by
     * {@link NiftyClientChannel#setReceiveTimeout(com.facebook.nifty.legacy.units.Duration)}
     *
     * @return
     */
    ...
    /**
     * Returns the timeout most recently set by
     * {@link NiftyClientChannel#setReadTimeout(com.facebook.nifty.legacy.units.Duration)}
     *
     * @return
     */
