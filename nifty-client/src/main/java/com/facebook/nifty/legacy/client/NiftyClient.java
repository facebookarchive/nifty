...
import com.facebook.nifty.legacy.client.socks.Socks4ClientBootstrap;
import com.facebook.nifty.legacy.core.ShutdownUtil;
...
public class NiftyClient implements Closeable
{
     ...
     * {@link com.facebook.nifty.legacy.client.NiftyClientConnector} instead (this method acts like such a
     * transport around a {@link com.facebook.nifty.legacy.client.FramedClientConnector}
     */
    @Deprecated
