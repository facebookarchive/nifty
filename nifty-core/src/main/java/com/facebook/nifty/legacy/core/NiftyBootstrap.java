...
public class NiftyBootstrap
{
            ...
            ChannelGroup allChannels)
    {
        ...
        ImmutableMap.Builder<ThriftServerDef, NettyServerTransport> builder =
                new ImmutableMap.Builder<ThriftServerDef, NettyServerTransport>();
    ...
    {
        ImmutableMap.Builder<ThriftServerDef, NiftyMetrics> builder =
                new ImmutableMap.Builder<ThriftServerDef, NiftyMetrics>();
