...
public class DefaultThriftFrameDecoder extends ThriftFrameDecoder
{
            ...
            throws TException
    {
        ...
        try {
            ...
            int startBufferPosition = decodeAttemptTransport.getBufferPosition();
            ...
            if (decodeAttemptTransport.getBuffer() == null) {
                messageLength = buffer.readerIndex() - messageStartReaderIndex;
            }
            else {
                messageLength = decodeAttemptTransport.getBufferPosition() - startBufferPosition;
            }
